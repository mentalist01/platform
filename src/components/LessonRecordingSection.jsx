...
const instructions = [
  ...
  ['Между уроками и после последнего занятия', [
    'Завершите урок кнопкой на платформе. Через несколько секунд OBS остановит запись и сохранит файл. Просто выход из звонка Телемоста не заменяет завершение урока на платформе.',
